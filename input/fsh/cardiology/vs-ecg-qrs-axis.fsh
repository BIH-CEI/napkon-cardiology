...
* $ncard#ecg-qrs-axis-si-sii-siii-type "ECG: QRS axis S(I)S(II)S(III) type" // SISIISIII-Typ
* $ncard#ecg-qrs-axis-si-qiii-type "ECG: QRS axis S(I)Q(III) type" // SIQIII-Typ

...
ValueSet: ECGBundleBranchBlock
Id: ecg-bundle-branch-block
Title: "ECG Bundle Branch Block"
Description: "Bundle branch block types"
//* $sct#164898000 "Electrocardiographic heart block (finding)" -- not used
...
* $sct#445211001 "Left posterior fascicular block on electrocardiogram (finding)" // Linksposteriorer Hemiblock
* $sct#445481009 "Bifascicular block on electrocardiogram (finding)" // Bifaszikulärere Block
* $sct#164899008 "Electrocardiogram: no heart block (finding)" // Kein Schenkelblock
// Keine Informationen verfügbar -- missing

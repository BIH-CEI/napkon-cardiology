...
* $sct#84114007 "Heart failure (disorder)" // Herzinsuffizienz - ok (synonymous of cardiac insuffiency)
* $sct#85898001 "Cardiomyopathy (disorder)" // Kardiomyopathie - ok
* $sct#13213009 "Congenital heart disease (disorder)" // Angeborener Herzfehler - ok
